<?php
 ...
 if (isset($_POST['cadastro'])){
    ...
    if (isset($_FILES['imagem'])){
        ...
        move_uploaded_file($FILES['imagem']['tmp_name'], $produto->getImagemDiretorio()); 
    }
...
<head>
    ...
    <title>Lica Fashion - Cadastrar Produto</title>
</head>
<body>
<main>
    <section class="container-admin-banner">
        <img src="img/logo-licafashion-horizontal.png" class="logo-admin" alt="logo Lica Fashion">
        <h1>Cadastro de Produtos</h1>
        <img class= "ornaments" src="img/dress.png" alt="ornaments dress">
    </section>
        ...
        <form  method="post">
            ...
            <div class="container-radio">
                <div>
                    ...
                    <input type="radio" id="vestido" name="tipo" value="Vestido" checked>
                </div>
                <div>
                    <label for="cropped">Cropped</label>
                    <input type="radio" id="cropped" name="tipo" value="Cropped">
                </div>
            </div>
